...
```powershell
git clone <repo-url>
cd digital-scholarship-mngmt-system/Digital-Scholarship-Management-System/ClientApp
npm install
```
...
If anyone ever needs to scaffold a *new* Angular project from scratch (not this one), here's what was selected when this project was created:
