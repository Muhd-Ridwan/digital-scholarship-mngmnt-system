...
// Resend emails on sponsor approve/reject
...
// Cognito admin client for lock/unlock and sponsor approve/reject
builder.Services.AddSingleton<IAmazonCognitoIdentityProvider>(new AmazonCognitoIdentityProviderClient(awsCredentials, cognitoRegionEndpoint));
// S3 for sponsor certificate presigned URLs
builder.Services.AddSingleton<IAmazonS3>(new AmazonS3Client(awsCredentials, s3RegionEndpoint));
// DynamoDB for the audit log
